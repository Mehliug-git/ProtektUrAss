...
let changeHeaderListener = function(details) {
    ...
    for (var i = 0; i < details.requestHeaders.length; ++i) {
      ...
      if (details.requestHeaders[i].name === 'User-Agent') {
        const userAgent_list = ["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36 Edg/119.0.0.0	",
        ...
        "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Safari/537.36 Edg/117.0.2045.",
